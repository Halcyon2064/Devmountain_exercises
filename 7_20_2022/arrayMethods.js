...
// // CODE HERE
const totalPopulation = populations.reduce((prev_value, curr_value) => prev_value + curr_value, 0)
...
// // CODE HERE
const totalprice = orders.map((order) => order.price + order.tax)
...
// /*
//   Use a high order method(s) to get the sum of bobs Total.
// */

// // CODE HERE
const bobstotal = purchases.filter((purchase) => purchase.owner == 'Bob').map((purchase)=>purchase.price).reduce((prev_value, curr_value) => prev_value + curr_value, 0)
